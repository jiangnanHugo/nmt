...
class HierarchicalSoftmax():
    ...
    def __init__(self, tree, size, mb_size):
        ...
        gb = theano.tensor.nnet.blocksparse.SparseBlockGemv()
        ...
        def predict_step(current_node, input_vector):
            ...
            node_res_r = T.nnet.sigmoid(-1 * T.sum(self.wp_matrix[current_node]* input_vector,axis=-1))
            ...
            return next_node, labelings, choice,node_res_l

        outputs_info = [fires, None, None,None]
